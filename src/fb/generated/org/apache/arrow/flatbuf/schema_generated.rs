...
pub fn root_as_schema(buf: &[u8]) -> Result<Schema<'_>, ::flatbuffers::InvalidFlatbuffer> {
...
pub fn size_prefixed_root_as_schema(buf: &[u8]) -> Result<Schema<'_>, ::flatbuffers::InvalidFlatbuffer> {
